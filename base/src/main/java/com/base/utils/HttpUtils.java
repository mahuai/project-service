...
import com.base.utils.bean.response.HttpResponseBean;
 ...
 * @author future
 * @Description:
 * @Package com.base.utils project-service
 * @date: Created in 2018/7/1017:33
 */
public class HttpUtils {
    ...
    private void initHttpClient() {
        if (requestConfig == null) {
            requestConfig = RequestConfig.custom().setSocketTimeout(defaultTimeout).setConnectTimeout(DEFAULT_CONNECT_TIMEOUT)
                    .setConnectionRequestTimeout(DEFAULT_CONNECT_TIMEOUT).setCookieSpec(CookieSpecs.STANDARD_STRICT)
    ...
    public String doPostStr(String url, String postStr) {
        ...
        try {
            HttpPost httpPost = new HttpPost(url);
            StringEntity stringEntity = new StringEntity(postStr, requestEncoding);
    ...
    public String doPostUrl(String url, Map<String, String> params) {
        ...
        try {
            ...
            StringEntity stringEntity = new StringEntity(jsonStr, requestEncoding);
    ...
    public HttpResponseBean doPostMapResponseAlphaj(String url, Map<String, String> params, String encoding) {
        ...
        try {
            ...
            ub.setParameters(pairs);
            String jsonStr = JsonUtils.objtoJson(params);
            StringEntity stringEntity = new StringEntity(jsonStr, encodingCharset);
            HttpPost httpPost = new HttpPost(ub.build());
    ...
    public static boolean ipIsValid(String ipSection, String ip) {
        ...
        ip = ip.trim();
        final String REGX_IP = "((25[0-5]|2[0-4]\\d|1\\d{2}|[1-9]\\d|\\d)\\.){" + count + "}(25[0-5]|2[0-4]\\d|1\\d{2}|[1-9]\\d|\\d)";
